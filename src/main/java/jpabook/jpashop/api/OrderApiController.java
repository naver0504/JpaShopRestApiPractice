...
public class OrderApiController {
    ...
    public ResponseEntity<?> orderV3_page(@RequestParam(value = "offset", defaultValue = "0") int offset,
    ...
    public ResponseEntity<List<OrderQueryDto>> orderV4() {
        return ResponseEntity.ok(orderQueryRepository.findOrderQueryDtos());

    }

    @GetMapping("/api/v5/orders")
    public ResponseEntity<List<OrderQueryDto>> orderV5() {
        return ResponseEntity.ok(orderQueryRepository.findAllByDto_optimization());
